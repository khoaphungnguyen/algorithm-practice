...
func Main() {
...

	{
		...
		case "9":
			...
			CoinChange()
		case "10":
			fmt.Println("Enter an array of distinct integers candidates and a target integer target for returning a list of all unique combinations of candidates(e.g.,'candidates = [2,3,6,7], target = 7' --> '[[2,2,3],[7]]' coins): ")
			CombinationSum()
		case "11":
			fmt.Println("Given a set of distinct integers, nums, return all possible subsets (e.g.,'nums = [1,2,3]'): ")
			Sunset()
		default:
...
/*
	...
	39. Medium - https://leetcode.com/problems/combination-sum/description/
	78. Medium - https://leetcode.com/problems/subsets/description/
*/
